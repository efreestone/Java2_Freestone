...
public class MainActivity extends Activity implements MainActivityFragment.OnListItemSelected {
	...
	// onActivityResult is called when returning from Details or Device orientation changes to Landscape on Details.
	// Details passes movie object back via intent extras which are used for rating alert and or Details display
